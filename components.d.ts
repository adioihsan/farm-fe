...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    ConfirmDialogProvider: typeof import('./src/components/providers/ConfirmDialogProvider.vue')['default']
    Dashboard: typeof import('./src/components/layout/dashboard/index.vue')['default']
    DashboardSidebar: typeof import('./src/components/layout/dashboard/DashboardSidebar.vue')['default']
    DataTable: typeof import('./src/components/pages/farm/data-table.vue')['default']
    DataTableDropwon: typeof import('./src/components/pages/farm/data-table-dropwon.vue')['default']
    ...
    FarmDeleteDialog: typeof import('./src/components/pages/farm/farm-delete-dialog.vue')['default']
    FarmTable: typeof import('./src/components/pages/farm/farm-table.vue')['default']
    FarmTableDropdown: typeof import('./src/components/pages/farm/farm-table-dropdown.vue')['default']
